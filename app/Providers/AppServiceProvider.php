...
use App\Repositories\NutrientRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(NutrientRepositoryInterface::class, NutrientRepository::class);
        $this->app->bind(NutritionLookupServiceInterface::class, OpenFoodFactsNutritionLookupService::class);
