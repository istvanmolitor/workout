<section class="w-full max-w-lg">
    <div class="flex items-center gap-3">
        ...
        <div>
            <flux:heading size="xl">{{ __('Log sleep') }}</flux:heading>
            <flux:subheading>{{ __('Record when you slept') }}</flux:subheading>
        </div>
    </div>
    ...
    <form wire:submit="save" class="mt-6 space-y-6">
        ...
        <flux:textarea wire:model="notes" :label="__('Notes')" :placeholder="__('Anything worth remembering about this night')" rows="3" />
